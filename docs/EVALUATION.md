...
|---|---|---|
| home renders | pass |  |
| demo lot graded | pass | 4450 ms for 4 photos incl. decode |
| Tier-1 model ran in the browser (ONNX Runtime Web) | pass | {"n":56,"withP":56,"disagree":2,"ms":[111,38,106,93]} |
| bulb sheet shows reasons | pass | 2 reason lines |
| override + contest recorded | pass |  |
| receipt has QR | pass |  |
| QR payload size | pass | 3015 base45 chars |
...
| auto-shutter fired and measured | pass | 8 onions measured. Scale: intrinsics · 649 ms |
